            ...
            <div class="form-group row">
                <div class="col-sm-9">
                    <div class="custom-control custom-switch">
                            <label for="salesperson" class="form-label invoice-mail"><h4>Salary Slip Via Mail:</h4></label>
                            ...
                            <button style="width: 120px; float:right;" type="button" onclick="total_ammount_price()" class="btn btn-primary mt-2">Total</button>      
                        </div>
                </div>
                <div class="col-sm-2">
                    <button style="width: 120px; float:right;" type="submit"  class="btn btn-primary mt-2">Salary Generate</button>      
                </div>
                <div class="col-sm-1">   
