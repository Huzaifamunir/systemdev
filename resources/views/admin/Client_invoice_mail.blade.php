	...
	<div class="container-fluid px-5 py-5">
	  <div class="row row1">
	    ...
	    <div class="float-right bg-dark mt-5 mx-auto">
	      <img class="img-fluid" src="https://codify.pk/public/assets/images/logo.png">
	    </div>
	    </div>
		  ...
		  <div class="row">
		    	...
		    	<div class="col">
				    <div class="float-left">
				        ...
				        <section style="color: black;">M15, First Floor, Mid Way Centrum, 6th Rd, Satellite Town, Rawalpindi</section>
				        <section style="color: black;">Rawalpindi,Pakistan,44000</section>
