...
Route::get('blackblaze',[SettingController::class,'blackblaze'])->name('blackblaze');
Route::post('add_aws',[SettingController::class,'add_aws'])->name('add_aws');
Route::get('smtp',[SettingController::class,'smtp'])->name('smtp');
Route::post('add_mail',[SettingController::class,'add_mail'])->name('add_mail');
...
/*route for screenshot */
Route::get('screenshots',[ReportController::class,'screenshots'])->name('screenshots');
Route::get('subfolder/{id}',[ReportController::class,'subfolder'])->name('subfolder');

Route::post('getscreenshots',[ReportController::class,'getscreenshots'])->name('getscreenshots');

Route::get('deletess/{id}',[ReportController::class,'deletess'])->name('deletess');
